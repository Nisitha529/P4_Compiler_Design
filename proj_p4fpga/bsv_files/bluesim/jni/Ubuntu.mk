...
CFLAGS_COMMON = -O -g -I$(DTOP)/jni -I$(CONNECTALDIR) -I$(CONNECTALDIR)/cpp -I$(CONNECTALDIR)/lib/cpp -I/home/vboxuser/p4fpga/cpp  -Wall -Werror -I$(DTOP)/jni -I$(CONNECTALDIR) -I$(CONNECTALDIR)/cpp -I$(CONNECTALDIR)/lib/cpp -I/home/vboxuser/p4fpga/cpp -std=c++11 -L\"/home/hwang/questasim/questa_sim/gcc-4.3.3-linux_x86_64/lib64\"
CFLAGS = $(CFLAGS_COMMON)
CFLAGS2 = 

include $(DTOP)/Makefile.autotop
include $(CONNECTALDIR)/scripts/Makefile.connectal.application
SOURCES = /home/vboxuser/p4fpga-examples/simple_router/main.cpp /sw/lpcap.c /home/vboxuser/p4fpga-examples/simple_router/app_init.cpp /home/vboxuser/connectal/cpp/dmaManager.c /home/vboxuser/connectal/cpp/platformMemory.cpp /home/vboxuser/connectal/cpp/transportXsim.c $(PORTAL_SRC_FILES)
