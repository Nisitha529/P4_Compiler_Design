module load_balance_p4rtl_top #(
  ...
  egress_processing_generated u_egress (
    ...
    .tcp_valid     (slot_phv_tcp_valid[deq_slot]),
    ...
    .tcp_srcPort  (slot_phv_tcp_srcPort[deq_slot]),
    .tcp_dstPort  (slot_phv_tcp_dstPort[deq_slot]),
    .tcp_seqNo  (slot_phv_tcp_seqNo[deq_slot]),
    .tcp_ackNo  (slot_phv_tcp_ackNo[deq_slot]),
    .tcp_dataOffset  (slot_phv_tcp_dataOffset[deq_slot]),
    .tcp_res  (slot_phv_tcp_res[deq_slot]),
    .tcp_ecn  (slot_phv_tcp_ecn[deq_slot]),
    .tcp_ctrl  (slot_phv_tcp_ctrl[deq_slot]),
    .tcp_window  (slot_phv_tcp_window[deq_slot]),
    .tcp_checksum  (slot_phv_tcp_checksum[deq_slot]),
    .tcp_urgentPtr  (slot_phv_tcp_urgentPtr[deq_slot]),
    .meta_ecmp_select  (slot_meta_ecmp_select[deq_slot]),
  ...
  always_ff @(posedge clk) begin
    if (!rst_n) begin
      ...
      if (proc_out_valid) begin
        ...
        slot_phv_tcp_valid[ig_slot] <= out_tcp_valid;
        ...
        slot_phv_tcp_srcPort[ig_slot] <= out_tcp_srcPort;
        slot_phv_tcp_dstPort[ig_slot] <= out_tcp_dstPort;
        slot_phv_tcp_seqNo[ig_slot] <= out_tcp_seqNo;
        slot_phv_tcp_ackNo[ig_slot] <= out_tcp_ackNo;
        slot_phv_tcp_dataOffset[ig_slot] <= out_tcp_dataOffset;
        slot_phv_tcp_res[ig_slot] <= out_tcp_res;
        slot_phv_tcp_ecn[ig_slot] <= out_tcp_ecn;
        slot_phv_tcp_ctrl[ig_slot] <= out_tcp_ctrl;
        slot_phv_tcp_window[ig_slot] <= out_tcp_window;
        slot_phv_tcp_checksum[ig_slot] <= out_tcp_checksum;
        slot_phv_tcp_urgentPtr[ig_slot] <= out_tcp_urgentPtr;
        slot_meta_ecmp_select[ig_slot] <= proc_out_meta_ecmp_select;
