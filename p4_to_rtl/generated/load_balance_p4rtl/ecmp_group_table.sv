module ecmp_group_table #(
  ...
  always_comb begin
    for (_cj = 0; _cj < DEPTH; _cj = _cj + 1) begin
      ...
      p_ecmp_mask_l0_c[_cj] = mem_p_ecmp_mask[_cj];
    end
  end
  ...
  always_comb begin
    for (_tj_l1 = 0; _tj_l1 < 32; _tj_l1 = _tj_l1 + 1) begin
      if (2*_tj_l1+1 < 64) begin
        ...
        p_ecmp_mask_l1[_tj_l1] = hit_l0[2*_tj_l1] ? p_ecmp_mask_l0[2*_tj_l1] : p_ecmp_mask_l0[2*_tj_l1+1];
      end else begin
        hit_l1[_tj_l1] = hit_l0[2*_tj_l1];
        act_l1[_tj_l1] = act_l0[2*_tj_l1];
        p_ecmp_base_l1[_tj_l1] = p_ecmp_base_l0[2*_tj_l1];
        p_ecmp_mask_l1[_tj_l1] = p_ecmp_mask_l0[2*_tj_l1];
      end
    end
  end
  ...
  always_comb begin
    for (_tj_l2 = 0; _tj_l2 < 16; _tj_l2 = _tj_l2 + 1) begin
      if (2*_tj_l2+1 < 32) begin
        ...
        p_ecmp_mask_l2[_tj_l2] = hit_l1[2*_tj_l2] ? p_ecmp_mask_l1[2*_tj_l2] : p_ecmp_mask_l1[2*_tj_l2+1];
      end else begin
        hit_l2[_tj_l2] = hit_l1[2*_tj_l2];
        act_l2[_tj_l2] = act_l1[2*_tj_l2];
        p_ecmp_base_l2[_tj_l2] = p_ecmp_base_l1[2*_tj_l2];
        p_ecmp_mask_l2[_tj_l2] = p_ecmp_mask_l1[2*_tj_l2];
      end
    end
  end
  ...
  always_comb begin
    for (_tj_l3 = 0; _tj_l3 < 8; _tj_l3 = _tj_l3 + 1) begin
      if (2*_tj_l3+1 < 16) begin
        ...
        p_ecmp_mask_l3[_tj_l3] = hit_l2[2*_tj_l3] ? p_ecmp_mask_l2[2*_tj_l3] : p_ecmp_mask_l2[2*_tj_l3+1];
      end else begin
        hit_l3[_tj_l3] = hit_l2[2*_tj_l3];
        act_l3[_tj_l3] = act_l2[2*_tj_l3];
        p_ecmp_base_l3[_tj_l3] = p_ecmp_base_l2[2*_tj_l3];
        p_ecmp_mask_l3[_tj_l3] = p_ecmp_mask_l2[2*_tj_l3];
      end
    end
  end
  ...
  always_comb begin
    for (_tj_l4 = 0; _tj_l4 < 4; _tj_l4 = _tj_l4 + 1) begin
      if (2*_tj_l4+1 < 8) begin
        ...
        p_ecmp_mask_l4[_tj_l4] = hit_l3[2*_tj_l4] ? p_ecmp_mask_l3[2*_tj_l4] : p_ecmp_mask_l3[2*_tj_l4+1];
      end else begin
        hit_l4[_tj_l4] = hit_l3[2*_tj_l4];
        act_l4[_tj_l4] = act_l3[2*_tj_l4];
        p_ecmp_base_l4[_tj_l4] = p_ecmp_base_l3[2*_tj_l4];
        p_ecmp_mask_l4[_tj_l4] = p_ecmp_mask_l3[2*_tj_l4];
      end
    end
  end
  ...
  always_comb begin
    for (_tj_l5 = 0; _tj_l5 < 2; _tj_l5 = _tj_l5 + 1) begin
      if (2*_tj_l5+1 < 4) begin
        ...
        p_ecmp_mask_l5[_tj_l5] = hit_l4[2*_tj_l5] ? p_ecmp_mask_l4[2*_tj_l5] : p_ecmp_mask_l4[2*_tj_l5+1];
      end else begin
        hit_l5[_tj_l5] = hit_l4[2*_tj_l5];
        act_l5[_tj_l5] = act_l4[2*_tj_l5];
        p_ecmp_base_l5[_tj_l5] = p_ecmp_base_l4[2*_tj_l5];
        p_ecmp_mask_l5[_tj_l5] = p_ecmp_mask_l4[2*_tj_l5];
      end
    end
  end
  ...
  always_comb begin
    for (_tj_l6 = 0; _tj_l6 < 1; _tj_l6 = _tj_l6 + 1) begin
      if (2*_tj_l6+1 < 2) begin
        ...
        p_ecmp_mask_l6[_tj_l6] = hit_l5[2*_tj_l6] ? p_ecmp_mask_l5[2*_tj_l6] : p_ecmp_mask_l5[2*_tj_l6+1];
      end else begin
        hit_l6[_tj_l6] = hit_l5[2*_tj_l6];
        act_l6[_tj_l6] = act_l5[2*_tj_l6];
        p_ecmp_base_l6[_tj_l6] = p_ecmp_base_l5[2*_tj_l6];
        p_ecmp_mask_l6[_tj_l6] = p_ecmp_mask_l5[2*_tj_l6];
      end
    end
  end
  ...
  always_comb begin
    ...
    p_ecmp_base_c = hit_l6[0] ? p_ecmp_base_l6[0] : 14'b0;
    p_ecmp_mask_c = hit_l6[0] ? p_ecmp_mask_l6[0] : 16'b0;
  end
