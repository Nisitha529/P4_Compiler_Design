module egress_processing_generated (
  ...
  output logic        tx_pkts_incr_en,
  output logic [3:0] tx_pkts_incr_idx,
  ...
  logic [63:0] std_meta_ingress_timestamp_s1;
  logic drop_in_s1;
  logic drop_s1;
  logic valid_s2;
  ...
  logic [63:0] std_meta_ingress_timestamp_s2;
  logic drop_in_s2;
  logic drop_s2;
  ...
  logic [63:0] std_meta_ingress_timestamp__st1;
  logic drop_in__st1;
  ...
  logic [63:0] std_meta_ingress_timestamp__st2;
  logic drop_in__st2;
  ...
  always_ff @(posedge clk) begin
    if (!rst_n) begin
      ...
      std_meta_ingress_timestamp_s1 <= std_meta_ingress_timestamp;
      drop_in_s1 <= drop_in;
    end
  end
  ...
  always_comb begin
    ...
    std_meta_ingress_timestamp__st1 = std_meta_ingress_timestamp_s1;
  ...
  always_ff @(posedge clk) begin
    if (!rst_n) begin
      ...
      std_meta_ingress_timestamp_s2 <= std_meta_ingress_timestamp__st1;
  ...
  always_comb begin
    ...
    std_meta_ingress_timestamp__st2 = std_meta_ingress_timestamp_s2;
    ...
    tx_pkts_incr_en  = !drop_in__st2;
    tx_pkts_incr_idx = 4'(std_meta_egress_port__st2);
  end
