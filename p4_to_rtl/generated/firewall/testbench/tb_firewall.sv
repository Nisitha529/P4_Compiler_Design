...
module tb_firewall;
  ...
  initial begin
    ...
    pr_ingress_port=9'd1; pr_egress_spec_i=9'd0; #1;
    ...
    pr_ipv4_dst=32'hC0A80002; pr_ipv4_ttl=128; pr_egress_spec_i=9'd1; #1;
    ...
    pr_eth_dst=48'hAABBCCDDEEFF; pr_egress_spec_i=9'd3; #1;
    ...
    pr_ingress_port=9'd1; pr_egress_spec_i=9'd3; #1;
    ...
    pr_ipv4_proto=8'd1; pr_ipv4_ttl=64; #1;
    ...
    $display("  INT5: valid_out is one-cycle delayed");
    do_reset();
    pr_valid_in=1; #1;
    chk("INT5: valid_out=0 before edge", !pr_valid_out);
    @(posedge clk); #1;
    chk("INT5: valid_out=1 after edge",   pr_valid_out);
    pr_valid_in=0;
    @(posedge clk); #1;
