module deparser_generated (
  ...
  always_comb begin
    ...
    if (tcp_valid) begin
      pkt_hdr_out[159:0] = {tcp_srcPort, tcp_dstPort, tcp_seqNo, tcp_ackNo, tcp_dataOffset, tcp_res, tcp_cwr, tcp_ece, tcp_urg, tcp_ack, tcp_psh, tcp_rst, tcp_syn, tcp_fin, tcp_window, tcp_checksum, tcp_urgentPtr};
    end
