module smprobe_top #(
  ...
  // Free-running cycle counter for standard_metadata.ingress_timestamp.
  // xsa.p4 declares it bit<64> and defines no unit, so this counts
  // clk cycles; at 250 MHz a 64-bit counter wraps in roughly
  // 2339 years, and it is only ever compared/differenced.
  logic [63:0] ingress_ts_ctr;
  ...
  processing_generated u_proc (
    ...
    .std_meta_parsed_bytes  (16'({pkt_byte_len})),
    .std_meta_parser_error  (3'd0),  // NoError -- parser verify() not implemented
