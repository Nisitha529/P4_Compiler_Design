...
module processing_generated (
  ...
  logic [31:0] meta_byte_total_w_s1;
  logic [8:0] meta_port_seen_w_s1;
  ...
  logic [31:0] meta_byte_total_w_s2;
  logic [8:0] meta_port_seen_w_s2;
  ...
  logic [31:0] meta_byte_total_w__st1;
  logic [8:0] meta_port_seen_w__st1;
  ...
  logic [31:0] meta_byte_total_w__st2;
  logic [8:0] meta_port_seen_w__st2;
  ...
  // Metadata outputs (final value after the last stage)
  assign out_meta_byte_total = meta_byte_total_w__st2;
  assign out_meta_port_seen = meta_port_seen_w__st2;
  ...
  always_ff @(posedge clk) begin
    if (!rst_n) begin
      ...
      valid_s1 <= valid_in;
      drop_s1 <= drop__st0;
      meta_byte_total_w_s1 <= meta_byte_total_w;
      meta_port_seen_w_s1 <= meta_port_seen_w;
  ...
  always_comb begin
    drop__st1 = drop_s1;
    meta_byte_total_w__st1 = meta_byte_total_w_s1;
    meta_port_seen_w__st1 = meta_port_seen_w_s1;
  ...
  always_ff @(posedge clk) begin
    if (!rst_n) begin
      ...
      valid_s2 <= valid_s1;
      drop_s2 <= drop__st1;
      meta_byte_total_w_s2 <= meta_byte_total_w__st1;
      meta_port_seen_w_s2 <= meta_port_seen_w__st1;
  ...
  always_comb begin
    drop = drop_s2;
    meta_byte_total_w__st2 = meta_byte_total_w_s2;
    meta_port_seen_w__st2 = meta_port_seen_w_s2;
