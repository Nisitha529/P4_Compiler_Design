module ipv4_lpm_table #(
  ...
  always_comb begin
    for (_tj_l7 = 0; _tj_l7 < 8; _tj_l7 = _tj_l7 + 1) begin
      if (2*_tj_l7+1 < 16) begin
        ...
        p_dstAddr_l7[_tj_l7] = hit_l6[2*_tj_l7] ? p_dstAddr_l6[2*_tj_l7] : p_dstAddr_l6[2*_tj_l7+1];
        p_port_l7[_tj_l7] = hit_l6[2*_tj_l7] ? p_port_l6[2*_tj_l7] : p_port_l6[2*_tj_l7+1];
      end else begin
        hit_l7[_tj_l7] = hit_l6[2*_tj_l7];
        act_l7[_tj_l7] = act_l6[2*_tj_l7];
        p_dstAddr_l7[_tj_l7] = p_dstAddr_l6[2*_tj_l7];
        p_port_l7[_tj_l7] = p_port_l6[2*_tj_l7];
      end
    end
  end
  ...
  always_comb begin
    for (_tj_l8 = 0; _tj_l8 < 4; _tj_l8 = _tj_l8 + 1) begin
      if (2*_tj_l8+1 < 8) begin
        ...
        p_dstAddr_l8[_tj_l8] = hit_l7[2*_tj_l8] ? p_dstAddr_l7[2*_tj_l8] : p_dstAddr_l7[2*_tj_l8+1];
        p_port_l8[_tj_l8] = hit_l7[2*_tj_l8] ? p_port_l7[2*_tj_l8] : p_port_l7[2*_tj_l8+1];
      end else begin
        hit_l8[_tj_l8] = hit_l7[2*_tj_l8];
        act_l8[_tj_l8] = act_l7[2*_tj_l8];
        p_dstAddr_l8[_tj_l8] = p_dstAddr_l7[2*_tj_l8];
        p_port_l8[_tj_l8] = p_port_l7[2*_tj_l8];
      end
    end
  end
  ...
  always_comb begin
    for (_tj_l9 = 0; _tj_l9 < 2; _tj_l9 = _tj_l9 + 1) begin
      if (2*_tj_l9+1 < 4) begin
        ...
        p_dstAddr_l9[_tj_l9] = hit_l8[2*_tj_l9] ? p_dstAddr_l8[2*_tj_l9] : p_dstAddr_l8[2*_tj_l9+1];
        p_port_l9[_tj_l9] = hit_l8[2*_tj_l9] ? p_port_l8[2*_tj_l9] : p_port_l8[2*_tj_l9+1];
      end else begin
        hit_l9[_tj_l9] = hit_l8[2*_tj_l9];
        act_l9[_tj_l9] = act_l8[2*_tj_l9];
        p_dstAddr_l9[_tj_l9] = p_dstAddr_l8[2*_tj_l9];
        p_port_l9[_tj_l9] = p_port_l8[2*_tj_l9];
      end
    end
  end
  ...
  always_comb begin
    for (_tj_l10 = 0; _tj_l10 < 1; _tj_l10 = _tj_l10 + 1) begin
      if (2*_tj_l10+1 < 2) begin
        ...
        p_dstAddr_l10[_tj_l10] = hit_l9[2*_tj_l10] ? p_dstAddr_l9[2*_tj_l10] : p_dstAddr_l9[2*_tj_l10+1];
        p_port_l10[_tj_l10] = hit_l9[2*_tj_l10] ? p_port_l9[2*_tj_l10] : p_port_l9[2*_tj_l10+1];
      end else begin
        hit_l10[_tj_l10] = hit_l9[2*_tj_l10];
        act_l10[_tj_l10] = act_l9[2*_tj_l10];
        p_dstAddr_l10[_tj_l10] = p_dstAddr_l9[2*_tj_l10];
        p_port_l10[_tj_l10] = p_port_l9[2*_tj_l10];
      end
    end
  end
  ...
  always_comb begin
    hit_c = hit_l10[0];
    action_id_c = hit_l10[0] ? act_l10[0] : 2'd2;
    p_dstAddr_c = hit_l10[0] ? p_dstAddr_l10[0] : 48'b0;
    p_port_c = hit_l10[0] ? p_port_l10[0] : 9'b0;
  end
