module acl_table #(
  ...
  always_comb begin
    for (_cj = 0; _cj < DEPTH; _cj = _cj + 1) begin
      hit_l0_c[_cj] = mem_valid[_cj] && ((lkp_srcAddr & mem_mask_srcAddr[_cj]) == (mem_key_srcAddr[_cj] & mem_mask_srcAddr[_cj])) && ((lkp_protocol & mem_mask_protocol[_cj]) == (mem_key_protocol[_cj] & mem_mask_protocol[_cj]));
