...
`ifndef MDMA_DEFINES_SVH
   ...
   typedef struct packed {
    ...
    typedef struct packed {
        logic                      payload_fifo_almost_full;
...
//    } mdma_glbl_err_t;
    ...
    typedef struct packed {
        logic                                   int_mod_dis_th_crs;
        logic                                   int_mod_eff_wrb;
        logic                                   int_mod_dyn_en_int;
        logic                                   int_mod_dyn_en_std;
        logic                                   int_mod_rng_mty;
        logic                                   int_mod_usr_trig;
        logic                                   fwd;
        logic [$clog2($bits(mdma_qidx_t))-1:0]  th_exp;
        logic                                   vio_th_xcd_cm;
    ...
    typedef struct packed {
        ...
        logic [17:0]                stat_total_wrq_len_0; 
        logic [17:0]                stat_total_wpl_val_out_len_0;
        logic                       stat_total_wrq_len_match_1; 
        logic [17:0]                stat_total_wrq_len_1; 
        logic [17:0]                stat_total_wpl_val_out_len_1;
...
//        logic [7:0]                                     int_wcp_cpl_rid;
   ...
   // FIXME: 2 bits (wrb_timer_vld and timer_exp_vld) commented to make room for wider qid.
    ...
    typedef struct packed {
        ...
        logic                           ctxt_dec_wr_orig_isr_done;
