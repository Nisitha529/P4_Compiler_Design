...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L qdma_v5_0_6 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L gtwizard_ultrascale_v1_7_17 -L xil_defaultlib -L qdma_v5_0_6 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot qdma_0 xil_defaultlib.qdma_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim qdma_0 -key {Behavioral:sim_1:Functional:qdma_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb qdma_0.wdb xsim.dir libdpi.so)
