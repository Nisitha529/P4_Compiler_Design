...
#
# Script generated by Vivado on Tue Dec 09 22:48:57 +0530 2025
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname gtwizard_ultrascale_v1_7_17 -libname xil_defaultlib -libname qdma_v5_0_6 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../qdma_0_ex.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../qdma_0_ex.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work gtwizard_ultrascale_v1_7_17 $xmvlog_opts +incdir+"../../../../qdma_0_ex.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../qdma_0_ex.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work qdma_v5_0_6 $xmvlog_opts -sv +incdir+"../../../../qdma_0_ex.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/qdma_v5_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../qdma_0_ex.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
