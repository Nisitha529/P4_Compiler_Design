...
# set xvlog options
xvlog_opts="--incr --relax  -L qdma_v5_0_6 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_bram_ctrl_v4_1_9 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_bram_ctrl_1 xil_defaultlib.axi_bram_ctrl_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_bram_ctrl_1 -key {Behavioral:sim_1:Functional:axi_bram_ctrl_1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_bram_ctrl_1.wdb xsim.dir libdpi.so)
