...
design_libs=(xpm lib_pkg_v1_0_3 fifo_generator_v13_2_9 lib_fifo_v1_0_18 blk_mem_gen_v8_4_7 lib_bmg_v1_0_16 axi_pcie_v2_9_10 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 axi_amm_bridge_v1_0_19)
...
compile()
{
  ...
  vlogan -work axi_pcie_v2_9_10 $vlogan_opts +v2k \
  "../../../../pcie_implt.gen/sources_1/bd/pcie_block/ipshared/8d40/hdl/axi_pcie_v2_9_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vhdlan -work axi_pcie_v2_9_10 $vhdlan_opts \
  ...
  vlogan -work axi_amm_bridge_v1_0_19 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pcie_block xil_defaultlib.glbl -o pcie_block_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pcie_block_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pcie_block_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pcie_block_simv.daidir vcs_lib c.obj)
