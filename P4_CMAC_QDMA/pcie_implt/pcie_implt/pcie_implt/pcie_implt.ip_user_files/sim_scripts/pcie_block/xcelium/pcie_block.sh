...
#
# Script generated by Vivado on Tue Dec 23 14:56:15 +0530 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pcie_block.sh
...
#
# Usage        : pcie_block.sh
#                pcie_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pcie_block.sh [-reset_run]
#                pcie_block.sh [-reset_log]
#                pcie_block.sh [-help]
#
...
#                script (type 'pcie_block.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname lib_pkg_v1_0_3 -libname fifo_generator_v13_2_9 -libname lib_fifo_v1_0_18 -libname blk_mem_gen_v8_4_7 -libname lib_bmg_v1_0_16 -libname axi_pcie_v2_9_10 -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_14 -libname axi_amm_bridge_v1_0_19 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm lib_pkg_v1_0_3 fifo_generator_v13_2_9 lib_fifo_v1_0_18 blk_mem_gen_v8_4_7 lib_bmg_v1_0_16 axi_pcie_v2_9_10 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_14 axi_amm_bridge_v1_0_19)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "pcie_block.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pcie_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axi_pcie_v2_9_10 $xmvlog_opts \
  "../../../../pcie_implt.gen/sources_1/bd/pcie_block/ipshared/8d40/hdl/axi_pcie_v2_9_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvhdl -work axi_pcie_v2_9_10 -V93 $xmvhdl_opts \
  ...
  xmvlog -work axi_amm_bridge_v1_0_19 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.pcie_block xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.pcie_block -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log pcie_block_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pcie_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pcie_block.sh [-help]\n\
Usage: pcie_block.sh [-step]\n\
Usage: pcie_block.sh [-lib_map_path]\n\
Usage: pcie_block.sh [-reset_run]\n\
Usage: pcie_block.sh [-reset_log]\n\
Usage: pcie_block.sh [-keep_index]\n\
Usage: pcie_block.sh [-noclean_files]\n\n\
