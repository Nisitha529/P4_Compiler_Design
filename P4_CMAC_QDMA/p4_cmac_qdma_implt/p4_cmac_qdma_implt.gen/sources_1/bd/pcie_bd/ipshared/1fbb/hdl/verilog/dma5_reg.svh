...
typedef enum logic [5:0] { // Address            // Struct
    ...
    DMA_GLBL2_RRQ_BRG_THROT_A,      // Bridge Slave RRQ Throttle
    DMA_GLBL2_RRQ_PCIE_THROT_A,     // Global PCIE Data Mover throttle
    DMA_GLBL2_RRQ_AXIMM_THROT_A,    // Global AXIMM Data Mover throttle
    DMA_GLBL2_RRQ_PCIE_LAT0_A,      // Latency measurements for PCIE
    DMA_GLBL2_RRQ_PCIE_LAT1_A,      // Latency measurements for PCIE
    DMA_GLBL2_RRQ_AXIMM_LAT0_A,     // Latency measurements for AXIMM
    DMA_GLBL2_RRQ_AXIMM_LAT1_A,     // Latency measurements for AXIMM
