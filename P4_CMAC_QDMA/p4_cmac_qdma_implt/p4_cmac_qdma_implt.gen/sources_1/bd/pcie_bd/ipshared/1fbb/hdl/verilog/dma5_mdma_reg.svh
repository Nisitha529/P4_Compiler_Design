...
`include "dma5_defines.svh"
    ...
    typedef enum mdma_glbl_csr_addr_t {
        ...
        MDMA_GLBL_DSC_DBG_LAT0_A,
        MDMA_GLBL_DSC_DBG_LAT1_A,
        MDMA_GLBL_DSC_CRD_CTR0_A,
        MDMA_GLBL_DSC_CRD_CTR1_A,
        MDMA_GLBL_DSC_CRD_CTR2_A,
        MDMA_GLBL_DSC_CRD_CTR3_A,
        MDMA_GLBL_DSC_IMM_CRD_CTR0_A,
        MDMA_GLBL_DSC_IMM_CRD_CTR1_A,
        MDMA_GLBL_DSC_IMM_CRD_CTR2_A,
        MDMA_GLBL_DSC_IMM_CRD_CTR3_A,
        MDMA_GLBL_DSC_H2C_OUT_CTR0_A,
        MDMA_GLBL_DSC_H2C_OUT_CTR1_A,
        MDMA_GLBL_DSC_H2C_OUT_CTR2_A,
        MDMA_GLBL_DSC_H2C_OUT_CTR3_A,
        MDMA_GLBL_DSC_C2H_OUT_CTR0_A,
        MDMA_GLBL_DSC_C2H_OUT_CTR1_A,
        MDMA_GLBL_DSC_C2H_OUT_CTR2_A,
        MDMA_GLBL_DSC_C2H_OUT_CTR3_A,
        MDMA_GLBL_PERF_CNTR_CTL_A0,
        MDMA_GLBL_PERF_CNTR_CTL_A1, 
        MDMA_GLBL_FREE_CNT_A0,
        MDMA_GLBL_FREE_CNT_A1,
        MDMA_GLBL_AXIS_H2C_CNT_A0,
        MDMA_GLBL_AXIS_H2C_CNT_A1,
        MDMA_GLBL_AXIS_H2C_CNT_A2,
        MDMA_GLBL_AXIS_H2C_CNT_A3,
        MDMA_GLBL_AXIS_H2C_CNT_A4,
        MDMA_GLBL_AXIS_H2C_CNT_A5,
        MDMA_GLBL_AXIS_C2H_CNT_A0,
        MDMA_GLBL_AXIS_C2H_CNT_A1,
        MDMA_GLBL_AXIS_C2H_CNT_A2,
        MDMA_GLBL_AXIS_C2H_CNT_A3,
        MDMA_GLBL_AXIS_C2H_CNT_A4,
        MDMA_GLBL_AXIS_C2H_CNT_A5,
        MDMA_GLBL_M_AXI_WR_CNT_A0,
        MDMA_GLBL_M_AXI_WR_CNT_A1,
        MDMA_GLBL_M_AXI_WR_CNT_A2,
        MDMA_GLBL_M_AXI_WR_CNT_A3,
        MDMA_GLBL_M_AXI_WR_CNT_A4,
        MDMA_GLBL_M_AXI_WR_CNT_A5,
        MDMA_GLBL_M_AXI_RD_CNT_A0,
        MDMA_GLBL_M_AXI_RD_CNT_A1,
        MDMA_GLBL_M_AXI_RD_CNT_A2,
        MDMA_GLBL_M_AXI_RD_CNT_A3,
        MDMA_GLBL_M_AXI_RD_CNT_A4,
        MDMA_GLBL_M_AXI_RD_CNT_A5,
        MDMA_GLBL_M_AXIB_WR_CNT_A0,
        MDMA_GLBL_M_AXIB_WR_CNT_A1,
        MDMA_GLBL_M_AXIB_WR_CNT_A2,
        MDMA_GLBL_M_AXIB_WR_CNT_A3,
        MDMA_GLBL_M_AXIB_WR_CNT_A4,
        MDMA_GLBL_M_AXIB_WR_CNT_A5,
        MDMA_GLBL_M_AXIB_RD_CNT_A0,
        MDMA_GLBL_M_AXIB_RD_CNT_A1,
        MDMA_GLBL_M_AXIB_RD_CNT_A2,
        MDMA_GLBL_M_AXIB_RD_CNT_A3,
        MDMA_GLBL_M_AXIB_RD_CNT_A4,
        MDMA_GLBL_M_AXIB_RD_CNT_A5,
        MDMA_GLBL_S_AXI_WR_CNT_A0,
        MDMA_GLBL_S_AXI_WR_CNT_A1,
        MDMA_GLBL_S_AXI_WR_CNT_A2,
        MDMA_GLBL_S_AXI_WR_CNT_A3,
        MDMA_GLBL_S_AXI_WR_CNT_A4,
        MDMA_GLBL_S_AXI_WR_CNT_A5,
        MDMA_GLBL_S_AXI_RD_CNT_A0,
        MDMA_GLBL_S_AXI_RD_CNT_A1,
        MDMA_GLBL_S_AXI_RD_CNT_A2,
        MDMA_GLBL_S_AXI_RD_CNT_A3,
        MDMA_GLBL_S_AXI_RD_CNT_A4,
        MDMA_GLBL_S_AXI_RD_CNT_A5,
        MDMA_GLBL_S_AXIS_CMP_CNT_A0,
        MDMA_GLBL_S_AXIS_CMP_CNT_A1,
        MDMA_GLBL_S_AXIS_CMP_CNT_A2,
        MDMA_GLBL_S_AXIS_CMP_CNT_A3,
        MDMA_GLBL_S_AXIS_CMP_CNT_A4,
        MDMA_GLBL_S_AXIS_CMP_CNT_A5
   ...
   typedef struct packed {
    ...
    typedef enum mdma_c2h_csr2_addr_t {
        ...
        MDMA_C2H_PAYLOAD_FIFO_ALMOST_FULL,
        MDMA_C2H_PFCH_CFG_3,
        MDMA_C2H_CMPT_CFG_0,
        MDMA_C2H_PFCH_CFG_4  
    ...
    typedef struct packed {
        logic [14:0]     glb_evt_timer_tick;     // How many clock cycles in one timer tick for global evtion timer
        logic            disable_glb_evt_timer;  // Disable the global evition timer feature
        logic [14:0]     evt_timer_tick;         // How many clock cycles in one timer tick for eviction timer per tag 
        logic            disable_evt_timer;      // Disable the eviction timer per tag feature
  ...
  typedef struct packed {
        logic [15:0] rsv;
        logic [11:0]  dbg_lat_qid; 
        logic         dsc_eng_lat_clr;
        logic [2:0]   sel;  // Used to select the ctxt_arb_sel and ctxt_arb_qid for each requester.
  } mdma_dsc_dbg_ctl_t;

  typedef struct packed {
        logic            enable;
        logic [30:0]     th;          // Threshold 
  } mdma_c2h_payload_fifo_almost_full_t;
