...
design_libs=(xilinx_vip xpm gtwizard_ultrascale_v1_7_17 xil_defaultlib qdma_v5_0_6)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work gtwizard_ultrascale_v1_7_17 $vlogan_opts +v2k +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work qdma_v5_0_6 $vlogan_opts -sverilog +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/qdma_v5_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.qdma_0 xil_defaultlib.glbl -o qdma_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./qdma_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key qdma_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc qdma_0_simv.daidir vcs_lib c.obj)
