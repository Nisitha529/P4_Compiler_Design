...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L qdma_v5_0_6"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L gtwizard_ultrascale_v1_7_17 -L xil_defaultlib -L qdma_v5_0_6 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot qdma_0 xil_defaultlib.qdma_0 xil_defaultlib.glbl -log elaborate.log
}
