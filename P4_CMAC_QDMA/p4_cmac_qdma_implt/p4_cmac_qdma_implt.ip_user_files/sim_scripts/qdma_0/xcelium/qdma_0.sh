...
#
# Script generated by Vivado on Tue Dec 09 22:44:36 +0530 2025
...
#
# Usage        : qdma_0.sh
#                qdma_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                qdma_0.sh [-reset_run]
#                qdma_0.sh [-reset_log]
#                qdma_0.sh [-help]
#
...
#                script (type 'qdma_0.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname gtwizard_ultrascale_v1_7_17 -libname xil_defaultlib -libname qdma_v5_0_6 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm gtwizard_ultrascale_v1_7_17 xil_defaultlib qdma_v5_0_6)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "qdma_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./qdma_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work gtwizard_ultrascale_v1_7_17 $xmvlog_opts +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work qdma_v5_0_6 $xmvlog_opts -sv +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/qdma_v5_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../p4_cmac_qdma_implt.gen/sources_1/ip/qdma_0/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.qdma_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.qdma_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log qdma_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./qdma_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: qdma_0.sh [-help]\n\
Usage: qdma_0.sh [-step]\n\
Usage: qdma_0.sh [-lib_map_path]\n\
Usage: qdma_0.sh [-reset_run]\n\
Usage: qdma_0.sh [-reset_log]\n\
Usage: qdma_0.sh [-keep_index]\n\
Usage: qdma_0.sh [-noclean_files]\n\n\
