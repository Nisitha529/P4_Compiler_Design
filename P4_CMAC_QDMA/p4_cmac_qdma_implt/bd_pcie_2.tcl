...
################################################################
# This is a generated script based on design: bd_pcie_2
#
...
proc create_root_design { parentCell } {
  ...
  set axi_smartconnect_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 axi_smartconnect_0 ]
  set_property -dict [list \
  ...
  # Create instance: packet_processor_0, and set properties
  set block_name packet_processor
  set block_cell_name packet_processor_0
  if { [catch {set packet_processor_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $packet_processor_0 eq "" } {
  ...
  assign_bd_address -offset 0x80000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces qdma_0/M_AXI] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
